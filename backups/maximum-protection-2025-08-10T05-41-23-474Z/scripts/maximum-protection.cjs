...
const ABSOLUTE_CRITICAL_FILES = {
  ...
  'scripts/debug-admin-access.cjs': { critical: 'MAXIMUM', description: 'Debug de acceso administrativo' },
  'scripts/test-redirect-flow.cjs': { critical: 'MAXIMUM', description: 'Prueba de flujo de redirección' },
  'scripts/analyze-logs.cjs': { critical: 'MAXIMUM', description: 'Análisis de logs del sistema' },
  'scripts/check-supabase-connectivity.cjs': { critical: 'MAXIMUM', description: 'Verificación de conectividad Supabase' },
  'scripts/debug-admin-panel.cjs': { critical: 'MAXIMUM', description: 'Debug del panel administrativo' },
  'scripts/test-admin-query.cjs': { critical: 'MAXIMUM', description: 'Prueba de consultas administrativas' },
  'scripts/diagnose-supabase-connection.cjs': { critical: 'MAXIMUM', description: 'Diagnóstico de conexión Supabase' },
  'scripts/debug-login.cjs': { critical: 'MAXIMUM', description: 'Debug del sistema de login' },
  ...
  'src/components/SystemStatus.tsx': { critical: 'MAXIMUM', description: 'Componente de estado del sistema' },

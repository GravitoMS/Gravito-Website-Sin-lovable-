          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                <Link to="/nosotros">
                  <Button size="lg" className="text-lg px-10 py-8 rounded-full border-2 border-foreground bg-transparent text-foreground hover:bg-foreground hover:text-background transition-all duration-fast">
                    Más Sobre Nosotros
                  </Button>
                </Link>
                <Link to="/servicios">
      ...
      <section className="py-20 bg-primary">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            >
              Sabemos que es mucha información. Por eso diseñamos la forma perfecta y sin riesgo para que empieces.
            </FadeInUp>

  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-6 py-20">
        <h2 className="text-4xl lg:text-6xl font-black text-center mb-16 relative inline-block w-full">
          <span className="relative overflow-hidden">
            ...
            <span className="absolute bottom-0 left-0 h-1 bg-secondary rounded-full animate-carousel-slide-precise" style={{
            width: '100%'
          }}></span>
          </span>
        </h2>
      ...
      <section className="bg-primary text-primary-foreground py-20">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-8xl lg:text-[12rem] font-black mb-12 text-center">
      ...
      {/* Footer */}
      <footer className="footer-liquid-glass py-8">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-8 text-sm text-muted-foreground">
            <div className="flex items-center space-x-2">
              <span>© 2025</span>
              <span>Gravito Media Solutions</span>
              <span>Todos los Derechos Reservados.</span>
            </div>
            <div className="flex items-center space-x-4">
              <a href="/privacy-policy" className="underline hover:text-foreground transition-colors duration-200">
                Privacy Policy & GDPR
              </a>
              <span className="w-1 h-1 bg-muted-foreground rounded-full"></span>
              <a href="/terms-of-service" className="underline hover:text-foreground transition-colors duration-200">
                Terms of Service
              </a>
            </div>
          </div>

...
const CRITICAL_FILES = {
  ...
  'scripts/debug-admin-access.cjs': 'Debug de acceso administrativo',
  'scripts/test-redirect-flow.cjs': 'Prueba de flujo de redirección',
  'scripts/analyze-logs.cjs': 'Análisis de logs del sistema',
  'scripts/check-supabase-connectivity.cjs': 'Verificación de conectividad Supabase',
  'scripts/debug-admin-panel.cjs': 'Debug del panel administrativo',
  'scripts/test-admin-query.cjs': 'Prueba de consultas administrativas',
  'scripts/diagnose-supabase-connection.cjs': 'Diagnóstico de conexión Supabase',
  'scripts/debug-login.cjs': 'Debug del sistema de login',
  ...
  'src/components/SystemStatus.tsx': 'Componente de estado del sistema',
...
const NEVER_DELETE_FILES = [
  ...
  'scripts/debug-admin-access.cjs',
  'scripts/test-redirect-flow.cjs',
  'scripts/analyze-logs.cjs',
  'scripts/check-supabase-connectivity.cjs',
  'scripts/debug-admin-panel.cjs',
  'scripts/test-admin-query.cjs'
];

          ...
          <div className="flex justify-center items-center mb-1">
            <div className="flex bg-muted rounded-lg p-1 relative overflow-hidden">
              ...
              <button
                ...
                className={`px-2.5 py-1 rounded-md font-medium transition-all duration-300 text-sm relative z-10`}
                style={{
              ...
              <Card key={index} className={`relative ${plan.isPopular ? 'border-primary shadow-lg' : plan.color} min-h-[700px] flex flex-col ${
                ...
                <CardContent className="text-center flex-shrink-0 pt-8">
                  <Link to="/contacto">
                    <Button 
                      size="lg" 
                      className="w-full mb-2 rounded-full border-2 border-foreground bg-transparent text-foreground hover:bg-foreground hover:text-background transition-all duration-300"
                    >
                      Agendar una llamada
                    </Button>
                  </Link>
